...
struct Actions {
    static let BaseURLLoading = "base_url_loading"
    static let DidStartProvisionalNavigation = "did_start_provisional_navigation"
    static let DoingAuthentication = "doing_authentication"
    ...
    static let ForegroundCSVScrappingBegin = "foreground_csv_scrapping_started"
}
