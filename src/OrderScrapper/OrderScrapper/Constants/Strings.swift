...
struct Strings {
    ...
    static let ManualSuccessMessage = "Your online orders have been updated. If you have placed new orders since you last downloaded orders you will receive incentives for those orders in the next 72 hours."
    ...
    static let OnlineTimeOutFailureMessage = "Downloading online orders is taking a while. If you would like to continue downloading please press continue"
   ...
   static let OnlineSuccessMessage = "Your online orders have been updated! Your weekly incentive will be awarded within the next 72 hours"
    static let OnlineFetchFailureMessage = "Downloading online orders failed"
    ...
    static let OnlineScrapingTimeoutMessage = "Downloading online orders is taking awhile.If you would like to continue downloading please press continue."
    static let OnlineZeroOrders = "You have 0 online orders.  Please try again when you have made an online order to receive an incentive"
    static let ManualScrapeNote = " "
    static let ZeroOrdersNote = "Incentives are awarded one time per week for downloading online orders from the home screen between Sunday and Tuesday. In order to qualify for the incentive at least one new online order must be downloaded from the week before."
    static let noNewOrders = "Thank you for updating your online orders. No new orders have been placed since you last downloaded your online orders"
    static let noNewOrdersNote = " "
}
