...
class AmazonService {
    ...
    static func registerConnection(amazonId: String, status: String, message: String, orderStatus: String, completionHandler: @escaping (AccountDetails?, String?) -> Void) -> APIClient {
